...
export const ADDRESSES = {
  amm: (import.meta.env.VITE_CONSTELLATION_AMM || '0x6B4EE164320e9E5583C0F6BEe14D5BABb5ba5095').trim(),
  deed: (import.meta.env.VITE_CONSTELLATION_DEED || '0x34eAC0fe797df2889d9dc59Cb98dCe24154BB9B6').trim(),
