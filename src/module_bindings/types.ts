...
export const JingMove = __t.enum("JingMove", ["Meltdown", "Freeze", "TectonicRoot", "Vacuum", "Erode"]);
...
export const Planet = __t.enum("Planet", ["Sun", "Moon", "Mercury", "Venus", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Pluto"]);
